---
title: "The once-hot market for biotech jobs and lab space has cooled. What now?"
person: kara-miller
section: by
type: news
year: 2023
...
authors: "Kara Miller"
source_url: https://www.bostonglobe.com/2023/07/26/business/boston-biotech-market/
retrieved: 2026-08-14
content: full-text
notes: "PROVENANCE: complete article body retrieved from the Boston Globe's own public Arc XP content API (`/pf/api/v3/content/fetch/content-feed`, `content_elements[].type == text`), which serves the full text to anonymous clients with no credential or session. Globe section: Biotech."
---
