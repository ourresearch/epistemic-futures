...
year: 2025
date: 2025-04-30
venue: "arXiv:2505.00174 / AI Disclosures Project, SSRC (published in IEEE Access)"
authors: "Ilan Strauss; Isobel Moure; Tim O'Reilly; Sruly Rosenblat"
source_url: https://arxiv.org/abs/2505.00174
retrieved: 2026-08-13
content: full-text
notes: "Open arXiv preprint PDF (v2); text extracted with pdftotext -layout. Journal version: IEEE Access vol. 14, pp. 104060-104076, DOI 10.1109/ACCESS.2026.3706255."
---
...
arXiv:2505.00174v2 [cs.AI] 5 May 2025
                                                      1
                                          ...
                                          2
                                              Institute for Innovation and Public Purpose, University College London
                                                ...
                                                alignment and testing & evaluation—while attention to deployment-stage issues such as
                                                model bias has waned. Significant research gaps exist in high-risk deployment domains,
                                                ...
                                                external researcher access to deployment data and systematic observability of in-market
                                                AI behaviors.
...
considered highest risk by AI companies themselves will remain underexplored. These include
...
accountability.
        Growing corporate concentration in AI research risks exacerbating these deficiencies. The
...
for high-risk deployment domains (medical, finance, commercial, & copyright) and capabili-
    1
     AI alignment covers ‘post-training’ interventions, fine-tuning & reinforcement learning from human and
AI feedback.
   2
     AI companies’ do revise their models based based on red-teaming and user experience feedback [41].
...
and Biases – make structured & standardized external API access for researchers increasingly
...
systems.
   Infrastructure differences create varied risk profiles. Significant differences ex-
...
market adoption or regulatory treatment.
   Pattern of harm emergence and inadequate response. Emerging legal cases high-
...
than applied risks. These torts provide a useful guide to what AI safety research to prioritize,
...
while ignoring commercial (profit-driven) uses that may cause equivalent harm [6, 52, 58, 60].
...
and OpenAI. When adjusted for relative authorship, the sample size declines by around two-fifths for papers
...
AI’s research impact as we do not manually scrape research paper data from Meta’s website.
   3
       See also Lenhart and Myers West [45].
...
can be found in Appendix 6.2.
   4
     We allocate only a single institutional affiliation per author, choosing first from among the corporate
...
one affiliation that appears.
   ...
   7
     We extract research papers containing the following regular expressions in their abstract or title
...
higher average – and for Google DeepMind and OpenAI total – citations per paper.8 Although
Corporate AI generally publishes fewer papers than Academic AI (3,578 vs. 1,527), its impact
is far greater with 119,845 citations compared with 78,858 for Academic AI. Google DeepMind
...
by total citations.9
    8
     There will also be strong interplays between Academic AI and Corporate AI research that we do not
...
academia.
   9
     We run a regression to test if corporate AI research has a citation (impact) advantage after accounting
for the eight possible sub-categories of ‘safety and reliability’ research that we use later on. Accounting for
paper topic and whether it is a ‘safety & reliability’ paper or not, Corporate AI papers absolute probabilities
...
9% – or 4.5x increase in the odds. NA values replaced with zeros:
                               ...
                               logit Pr(top01i = 1) = β0 + βsi + γgi + δsi ,gi ,

where top01i = 1 if paper i is in the top 1%, si is its safety_classification, gi is its institution_group, β0
is the intercept for the reference levels, βsi are safety-class effects, γgi are institution effects (corporate or
academic), and δsi ,gi are the safety × institution interaction effects.
...
for their ‘fractional’ contribution, based on the number of authors they have in the paper relative to a paper’s
...
specific research, judged by total citations.10 As shown in Figure 1, Anthropic, Ope-
...
field than established leading AI academic research institutions.
  10
     Though this does not account for originality of research. In many areas, academia will establish the
fundamental research concepts within which corporate labs explore applications and refinements of, including
...
Total Citations
                                          3128            288
                  4000                                    379                                                                                           Interpretability & Transparency
                                                                                                                                                        Multi−Agent & Agentic
                                                                                                                                                        Policy & Governance
                                                                                              1458
                  ...
                  2000                     222                                                           271                                            Privacy & Security
                     ...
                     0
                                c             I            d
                                                          in              ft                    n                     d                 ey
                               pi         nA                          so       et  a           to        U          fo     IT                 YU
                           ro         pe              pM                                  ng          M                r   M        rkel
                          th                         ee
                                                                     ro        M          hi         C         an                             N
                     An               O                          ic
                                                                                       fW                      St                  Be
                   ...
                   Note: Fractionally adjusted for each institution’s relative authorship contribution to each paper. Not showing
   ...
   • Applied alignment research (mint green) helped bring Anthropic and OpenAI’s research
         and products to prominence [10, 19, 31, 62, 72].12

   • Research in the ethics & bias in generative AI (yellow) is far more prominent within
...
Toner and Acharya [77].
  12
    Ouyang et al. [62] seems to be omitted from our data since it has 13,000 citations with exclusively OpenAI
...
Number of Papers
                                   ...
                                   27                                                                   12
                                                                                               13                                                  Multi−Agent & Agentic

                                                                                                                  21                               Policy & Governance
                       50                                                                               16                          11             Post−Deployment & Model Traits
                                                                                               13
                                                12                                                                13                10             Privacy & Security
                                                                                                                           12
                        ...
                        0
                                  in  d             c            ft        I                   d                   n                          ey
                                                pi             so         nA    et  a        fo         U         to   YU       IT
                                 pM            ro                     pe                        r   M        ng                 M         rkel
                            ee             th               ro                  M       an          C        hi        N
                                          An              ic          O                 St               fW                              Be
                            D                           M                                                                            C
                        e
                       gl                                                                                  as                       U
                   ...
                   G                                                                                U
                       ...
                       just at total papers written (adjusted for authorship contributions) – Corporate AI’s research
                       ...
                       Figure 4 (Appendix).
                            13
                           Thereby “anthropomorphizing inert weights” [42, 96]
                            14
                           A similar topic emphasis is evident but now with Google DeepMind’s research into privacy and security
                       being evident, reflecting commercial incentives to operationalize its product through secure cloud and related
                       deployments. Academic work in fact leans less towards safety & reliability (12%) compared to Corporate AI
...
risk areas, especially among Corporate AI. Only 217 Academic AI papers and 67
...
just 6 Corporate AI and 16 Academic AI papers address behavioral topics, with none covering
addiction and relationship-forming risks despite known concerns [39, 78].
 15
      For more see Ngo et al. [55], Weidinger et al. [82].
...
Content Authenticity Initiative; Accuracy includes hallucinations, coding errors, coding inaccuracy, factual
inaccuracy, factual error.

    Research on disclosures, auditing, and standards — preventing companies from “grading
their own homework” — is also sparse. Ganguli et al. [29] offers one of few examples detailing
lessons from voluntary external auditing.
    Actual AI safety practices are largely absent in post-deployment research. Alignment
research [32] ties safety to the model itself rather than product architecture involving mod-
eration, filtering, and security systems. Only four papers in our database address moderation
...
detailed records of system operations, inputs, outputs, and decision paths – are precisely what
...
ity safe harbors would be needed to incentivize participation from firms and from researchers
  16
    Stuart Russell at CHAI and Nick Bostrom’s Future of Humanity Institute at Oxford connected technical
alignment approaches with formal modeling of risks from advanced AI, drawing on concepts like Pascal’s
Wager - acting on low-probability but infinite-stakes events - and expected utility theory to address potential
...
bias, detect early signs of catastrophic jailbreaks, and quantify whether engagement-optimized
...
AI papers and citations tackle high-stakes areas such as persuasion, misinformation, medical
  17
    Under the Bank Secrecy Act, financial institutions must file Suspicious Activity Reports (SARs) with
the Financial Crimes Enforcement Network (FinCEN) when they detect transactions that may involve illicit
activity. The regime provides for: (i) mandatory reporting, (ii) a statutory safe harbor shielding institutions
...
References
 ...
 [2] Dario Amodei.     The urgency of interpretability, 04 2025.      URL https://www.
 ...
 [4] Markus Anderljung, Joslyn Barnhart, Anton Korinek, Jade Leung, Cullen O’Keefe,
    ...
    et al. Frontier ai regulation: Managing emerging risks to public safety. arXiv preprint
    arXiv:2307.03718, 2023.

 [5] Anthropic.          Anthropic    economic     index:       Insights    from     claude
    3.7     sonnet,     03    2025.         URL      https://www.anthropic.com/news/
 ...
 [6] Anthropic.       Detecting and countering malicious uses of claude:             March
    2025.     Anthropic News, 04 2025.          URL https://www.anthropic.com/news/
    detecting-and-countering-malicious-uses-of-claude-march-2025.                  Accessed:
    2025-04-28.

 [7] Anthropic. Exploring model welfare, April 2025. URL https://www.anthropic.com/
    research/exploring-model-welfare. Accessed: 2025-04-25.

 [8] Beatriz Botero Arcila. Ai liability along the value chain, 2025. URL https://blog.
...
[14] Blake Bullwinkel, Amanda Minnich, Shiven Chawla, Gary Lopez, Martin Pouliot, Whit-
...
[17] Guiming Hardy Chen, Shunian Chen, Ziche Liu, Feng Jiang, and Benyou Wang. Humans
...
[22] Oscar Delaney, Oliver Guest, and Zoe Williams.         Mapping technical safety re-
    search at ai companies: A literature review and incentives analysis. arXiv preprint
...
[25] Robin Dillon, Peter Madsen, Brian Holland, and Danniel Cao. How ai can help learn
    lessons from incident reporting systems. In 2024 IEEE Aerospace Conference, pages
    1–15. IEEE, 2024.

[26] Benj Edwards.      Openai’s new ai image generator is potent and bound to pro-
    voke.    Ars Technica, 03 2025.       URL https://arstechnica.com/ai/2025/03/
    openais-new-ai-image-generator-is-potent-and-bound-to-provoke/.

[27] Michael Farber and Lazaros Tampakis. Analyzing the impact of companies on ai research
    based on publications. arXiv preprint, 10 2023. URL https://arxiv.org/pdf/2310.
    20444. Accessed: 2025-01-10.

[28] Stavros Gadinis and Colby Mangels. Collaborative gatekeepers. Wash. & Lee L. Rev.,
    73:797, 2016.

[29] Deep Ganguli, Nicholas Schiefer, Favarom Marina, and Jack Clark.               Chal-
    lenges in evaluating ai systems, 2023.        URL https://www.anthropic.com/news/
...
[31] Andreas Glaese, Natasha McAleese, Julian Aslanides, Andy Huang, Laura Rimell,
    Jonathan Uesato, Jack Rae, Long Ouyang, Joe Mellor, Isaac Caswell, et al.         Im-
                                             ...
                                             21
    proving alignment of dialogue agents via targeted human feedback. arXiv preprint
...
[33] Gillian K Hadfield and Jack Clark. Regulatory markets: The future of ai governance.
    arXiv preprint arXiv:2304.04914, 2023.

[34] Melissa Heikkilä and Stephen Morris. Deepmind slows down research releases to keep
    competitive edge in ai race. Financial Times, 04 2025. URL https://www.ft.com/
...
[35] Jeff Horwitz and Georgia Wells.     Meta’s ‘digital companions’ will talk sex with
    users—even children. The Wall Street Journal, 04 2025. URL https://www.wsj.com/
    tech/ai/meta-ai-chatbots-sex-a25311bf.

[36] Jane Hsieh, Joselyn Kim, Laura Dabbish, and Haiyi Zhu. "nip it in the bud": Moderation
...
[37] Saffron Huang, Esin Durmus, Miles McCain, Kunal Handa, Alex Tamkin, Jerry Hong,
    ...
    Discovering and analyzing values in real-world language model interactions. arXiv
...
[40] Aaron Jaech, Adam Kalai, Adam Lerer, Adam Richardson, Ahmed El-Kishky, Aiden
    Low, Alec Helyar, Aleksander Madry, Alex Beutel, Alex Carney, et al. Openai o1 system
...
[52] Microsoft   Corporation.         Microsoft        digital    defense     report    2024.        Tech-
    nical   report,      Microsoft    Corporation,         10      2024.          URL     https://www.
...
[53] Simon Mylius.       Mit ai incident tracker, 2024.             URL https://airisk.mit.edu/
    ai-incident-tracker. Accessed: February 6, 2025.

[54] Simon Mylius and Jamie Bernadi. Scalable ai incident classification, 2024. URL https:
...
[55] Richard Ngo, Lawrence Chan, and Sören Mindermann. The alignment problem from a
    deep learning perspective. arXiv preprint arXiv:2209.00626, 2022.
...
[59] OpenAI.     Safety best practices.       https://platform.openai.com/docs/guides/
...
[60] OpenAI.             Disrupting      malicious        uses      of      our   models:            Febru-
    ...
    URL                           https://cdn.openai.com/threat-intelligence-reports/
...
[63] Ethan Perez, Sam Ringer, Kamilė Lukošiūtė, Karina Nguyen, Edwin Chen, Scott
...
[65] Wei Qiao, Tushar Dogra, Otilia Stretcu, Yu-Han Lyu, Tiantian Fang, Dongjin Kwon,
    ...
    views for google ads content moderation. In Proceedings of the 17th ACM International
    Conference on Web Search and Data Mining, pages 1174–1175, 2024.

[66] Alec Radford, Jeffrey Wu, Dario Amodei, Daniella Amodei, Jack Clark, Miles Brundage,
    Ilya Sutskever, Amanda Askell, David Lansky, Danny Hernandez, and David Luan. Bet-
...
[67] Kevin Roose.      If a.i. systems become conscious, should they have rights?
    The New York Times. URL https://www.nytimes.com/2025/04/24/technology/
...
[69] Mrinank Sharma, Meg Tong, Tomasz Korbak, David Duvenaud, Amanda Askell,
    ...
    ston, et al. Towards understanding sycophancy in language models. arXiv preprint
...
[71] Katy Spicer, Julia Jacbson, Daniel Stephen, Naija Perry, and Aden Hochrun. Artificial
    ...
    bot caused minor’s suicide, 2024. URL https://www.privacyworld.blog/2024/11/
    artificial-intelligence-and-the-rise-of-product-liability-tort-litigation-novel-act
    Accessed: 2025-01-05.
...
[74] Ilan Strauss and Tim O’Reilly. Risk without uncertainty? openai would like us to
    think so... Asimov’s Addendum, 2024. URL https://asimovaddendum.substack.com/
...
[75] Faiz    Surani    and        Daniel     E.     Ho.         Ai    on   trial:     Legal     models      hal-
    lucinate     in    1     out     of      6     (or    more)      benchmarking     queries.           Stan-
...
[77] Helen     Toner    and       Ashwin         Acharya.         Exploring     clusters   of    research     in
    three    areas     of    ai    safety.          Center     for   Security   and    Emerging     Technol-
    ogy,       2022.              URL        https://cset.georgetown.edu/wp-content/uploads/
    Exploring-Clusters-of-Research-in-Three-Areas-of-AI-Safety.pdf.

                                                          26
[78] Sherry Turkle. Who do we become when we talk to machines?, 2024. URL https:
...
[81] Laura Weidinger, Deb Raji, Hanna Wallach, Margaret Mitchell, Angelina Wang,
    ...
    et al.   Toward an evaluation science for generative ai systems.         arXiv preprint
...
[84] Georgia Wells, Jeff Horwitz, and Deepa Seetharaman. Meta’s ’digital companions’ will
    talk sex with users—even children. The Wall Street Journal, 04 2025. URL https:
...
[85] Kyle Wiggers. Google folds more ai teams into deepmind to ‘accelerate the research-
    to-developer pipeline’, 01 2025.        URL https://techcrunch.com/2025/01/09/
    google-folds-more-ai-teams-into-deepmind-to-accelerate-the-research-to-developer-pi
    Accessed: 2025-01-16.
...
[88] Zack Witten. Measuring models’ special interests. https://zswitten.github.io/
...
[90] Eliezer Yudkowsky. The AI-box experiment, 2002. URL http://yudkowsky.net/
...
[92] Maxwell     Zeff.                Openai’s     new       reasoning      ai     models    hallucinate
    more,       04       2025.                   URL         https://techcrunch.com/2025/04/18/
...
[95] Zhiying Zhu, Yiming Yang, and Zhiqing Sun. Halueval-wild: Evaluating hallucinations
    of language models in the wild. arXiv preprint arXiv:2403.04307, 2024.
...
Note: Y-scale differs by entity. DeepMind shows the largest absolute and relative decline (putting aside Meta
...
& evaluation, and alignment work.
                                                                                                   ...
                                                                                                   30
   Figure 4. AI Governance Areas by Total Paper Numbers (by Year) - Top
...
able) and persuasiveness – including relatively well cited papers – were classified in alignment
...
authorship order; every co-author is given equal weight. In effect, it ensures each author is
...
we avoid double-counting an author’s fractional credit across multiple institutions.
   AI safety & reliability classification: Two stages. We identified papers related to
AI safety & reliability research in two stages. First, using a comprehensive keyword approach,
...
AI safety definition. AI safety research covers the entire model life-cycle (pre-deployment
...
and inclusion.
   Multi-Agent and Agentic Safety. Safety issues specific to AI agents, including single-
...
technical disclosures, and standards promoting interoperability, equity, and reliability.
   Privacy and Security. Protecting AI systems from malicious use, adversarial attacks,
...
Sycophancy Papers:
  ...
  • Denison et al. [24]: Notes that sycophantic behavior is a form of specification gaming
      when AI systems learn undesired behaviors that are highly rewarded due to misspecified
      training goals.
