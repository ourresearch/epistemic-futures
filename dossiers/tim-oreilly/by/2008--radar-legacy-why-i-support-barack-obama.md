---
title: "Why I Support Barack Obama"
person: tim-oreilly
section: by
type: blog-post
year: 2008
...
source_url: http://radar.oreilly.com/2008/10/why-i-support-barack-obama.html
...
In my talks this year, I have been outlining some of the world's great problems, highlighting some of the things that are being done by technology innovators to solve them, and urging my listeners to "[work on stuff that matters](http://radar.oreilly.com/2008/10/thoughts-on-financial-crisis.html)." 
...
I believe Barack Obama is that president. He is a man of intelligence, but also a man whose character and temperament seem suited to the problems of our age: unflappable, optimistic even in the face of adversity, willing to speak the truth about subjects that have long been taboo (I'm thinking of [his speech on race](http://www.huffingtonpost.com/2008/03/18/obama-race-speech-read-t_n_92077.html), and [his speech on fatherhood](http://www.realclearpolitics.com/articles/2008/06/obamas_speech_on_fatherhood.html)) and with unscripted reactions that show his fundamental decency (I'm thinking of [his reaction](http://embeds.blogs.foxnews.com/2008/09/01/obama-says-palin-pregnancy-off-limits/) to those who wanted to make a campaign issue of Sarah Palin's daughter's unplanned pregnancy.) 

Because this is a tech blog, not a political blog, though, I primarily want to address the subject of why members of the technical community should join me in supporting Barack Obama. (The New York Times has made [a compelling case](http://www.nytimes.com/2008/10/24/opinion/24fri1.html?_r=2&hp=&pagewanted=all) based on the broader issues, [as has Colin Powell](http://www.youtube.com/watch?v=b2U63fXBlFo).) I outline four principal reasons: 

1\. [Connected, Transparent Government](http://radar.oreilly.com/2008/10/why-i-support-barack-obama.html#transparency)   
2\. [The Financial Crisis](http://radar.oreilly.com/2008/10/why-i-support-barack-obama.html#financial)   
3\. [Climate Change](http://radar.oreilly.com/2008/10/why-i-support-barack-obama.html#climate)   
4\. [Net Neutrality](http://radar.oreilly.com/2008/10/why-i-support-barack-obama.html#neutrality)

I will also discuss some [important additional considerations](http://radar.oreilly.com/2008/10/why-i-support-barack-obama.html#other), personal and political, that I hope Radar readers who don't want to see politics in these pages, will forgive. 

_I want to be clear that this is my personal endorsement, and not an endorsement by O'Reilly Media. I'd like O'Reilly to be a company where people of all political persuasions are welcomed and supported, and feel free to express their personal opinions, as I have here._

**1\. Connected, Transparent Government**

Web 2.0 has shown the power of what I've elsewhere called [harnessing collective intelligence](http://www.oreillynet.com/pub/a/oreilly/tim/news/2005/09/30/what-is-web-20.html?page=2). Despite the claims of critics like Nick Carr and Andrew Keen, Google _does_ make us smarter. So does Wikipedia, and Amazon, YouTube, Facebook, the blogosphere, and Twitter. Our access to information today is unprecedented; the ability of individual citizens to discover and share important new ideas is greater than it has ever been in our history; important ideas are able to bubble up and become visible to those who need to know them. 

Barack Obama understands this. His campaign has demonstrated his ability to harness the internet not only for fundraising, but also his comfort with its decentralized nature. [my.barackobama.com](http://www.my.barackobama.com) is not a one-way fundraising machine, but a platform that has enabled his supporters to act independently, while coordinating their decentralized, bottom-up activities in a way that adds to their effectiveness. What's more, it is [a platform that has allowed supporters to disagree with him](http://www.techpresident.com/blog/entry/26952/the_fisa_protest_and_mybo_can_we_talk_can_they_listen), and so to shape his policies - a far cry from the current administration's belief that disagreement is equivalent to disloyalty. 
...
Those of you who follow my blog and my speeches know that I am a big believer that ["alpha geeks" show us the shape of the future](http://blog.jedchristiansen.com/2008/10/24/tim-oreilly-speaks-at-judge-business-school/). I've been watching the work of folks like Ellen Miller, Greg Elin and Micah Sifry at [the Sunlight Foundation](http://www.sunlightfoundation.com/), Adrian Holovaty at [Everyblock](http://www.everyblock.com), Carl Malamud at [public.resource.org](http://www.public.resource.org), and Tom Steinberg of [mysociety.org](http://www.mysociety.org) in the UK, and I believe that in an Obama administration, we'll have an unprecedented opportunity to put their pioneering applications and approaches to work to build a more responsive, more transparent, and more effective government. 
...
More than that, though, making the right decisions, coming up with the right regulations, will take insight into the nature of networks, the nature of markets, that can be profoundly informed by what we've learned from the internet over the past decade. I realized last year that there was a productive - nay an essential - dialogue to be held between the world of financial markets and the world of Web 2.0. (See [Web 2.0 Meets Wall Street (pdf)](http://downloads.oreilly.com/radar/r2/issue2.0.2.1.pdf).) It's why I launched the [Money:Tech conference](http://en.oreilly.com/money2009/public/content/home), and why I've been spending so much time thinking about what we can learn from the development of markets that are, effectively, run by computer programs, or as Richard Bookstaber put it so eloquently, [A Demon of Our Own Design](http://books.google.com/books?id=W4VZm8DfxSkC&dq=A+Demon+of+Our+Own+Design&source=gbs_summary_s&cad=0). 
...
Climate change and energy policy can no longer be dictated by "politically possible" but must be dictated by "technically necessary." NASA's James Hansen has recently argued that [an atmospheric CO2 concentration of 350 ppm looks to be the safe bet climate wise for humanity](http://www.washingtonpost.com/wp-dyn/content/article/2007/12/27/AR2007122701942.html). We are already at more than 380 ppm! (Here's [Hansen's full paper (pdf)](http://www.columbia.edu/~jeh1/2008/TargetCO2_20080407.pdf).) 

As my son-in-law [Saul Griffith](http://radar.oreilly.com/archives/2007/09/saul-griffith-macarthur.html) argued at our [Emerging Technology Conference](http://en.oreilly.com/et2009/public/content/home) earlier this year, [we need to pick a target CO2 concentration and work backwards to get to an energy policy](http://blip.tv/file/1018152), rather than guessing at an energy policy with fingers crossed, hoping for a climate outcome that is tolerable. 
...
Barack Obama [supports net neutrality](http://obama.senate.gov/podcast/060608-network_neutral/); John McCain, as in other areas, once again claims that [government should get out of the way](http://d5.allthingsd.com/20070529/d5-mccain/). 
...
Perhaps the most alarming aspect of what has happened in those years is the way that fear has been used to claim extraordinary power for the Presidency. Those of you who know my background know that my degree is in Greek and Latin Classics. So it's perhaps forgivable that historical parallels with ancient Rome are quick to come to my mind. The claims of the Bush administration to be above the law, its claims that the threat of terrorism demand the suspension of civil liberties, are eerily reminiscent of [the events that led to the end of the Roman Republic](http://www.nytimes.com/2006/09/30/opinion/30harris.html?pagewanted=all). Faced with an invasion by pirates (the terrorists of 68 BC), Pompey the Great was given extraordinary powers. Within a decade, Rome was a dictatorship, led by the one Senator who had supported Pompey's exaggerated claims, Julius Caesar. 
...
I understand their concerns. I hate to see a candidate with a perfect voting record on one side of an issue that so clearly divides the country, with passionate and compelling arguments on both sides. But I remind them that Obama said, in [his speech accepting the Democratic nomination](http://www.demconvention.com/barack-obama/), "We may not agree on abortion, but surely we can agree on reducing the number of unwanted pregnancies in this country." He expanded on these views in [an interview with Relevant Magazine](http://www.relevantmagazine.com/life_article.php?id=7591) in July. 
...
Senator McCain has made much of character in his career and in his campaign, yet he has run a race that gives the lie to those claims. He [hired the very people who used lies to undermine his campaign for the presidency in 2000](http://blogs.abcnews.com/politicalpunch/2008/09/mccain-hires-go.html); he has [adopted the sleazy tactics that he once abhorred](http://www.huffingtonpost.com/2008/10/17/report-mccain-using-same_n_135699.html). 
...
At the start of this election, I was prepared to give McCain serious consideration. But his behavior during the campaign forfeited my good opinion. The ancient philosopher Heraclitus once said that "Character is destiny." John McCain used that quote as the title of [his book](http://www.randomhouse.com/catalog/display.pperl/9781400064120.html), but it is Barack Obama who has demonstrated the sure character of a man who will not change how he acts for the sake of political gain. 
