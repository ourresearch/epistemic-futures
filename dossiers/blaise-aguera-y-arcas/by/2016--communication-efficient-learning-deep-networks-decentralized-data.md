...
source_url: http://arxiv.org/abs/1602.05629
retrieved: 2026-08-13
content: full-text
notes: "OpenAlex W4318619660, W2541884796 (duplicate record for the same arXiv paper) (type: preprint). Full text extracted from the open-access PDF at https://arxiv.org/pdf/1602.05629."
---
...
Artificial Intelligence and Statistics (AISTATS) 2017, Fort Lauderdale, Flordia, USA. JMLR: W&CP volume 54. Copyright 2017
by the authors.
...
A CNN with two 5x5 convolution layers (the first with 32
channels, the second with 64, each followed with 2x2 max
pooling), a fully connected layer with 512 units and ReLu
activation, and a final softmax output layer (1,663,370 total
...
IID, where the data is shuffled, and then partitioned into 100
...
4
Earlier versions of this paper incorrectly indicated summation
...
characters6 in the test set. This data is substantially unbalanced, with many roles having only a few lines, and a few
...
for a non-convex problem, one might conjecture the algorithm would converge to the same local minimum as long as
...
column is the IID dataset, and right is the pathological 2digits-per-client non-IID data.
