...
source_url: https://www.project-syndicate.org/commentary/sorting-and-managing-email-messages-by-esther-dyson
retrieved: 2026-08-14
content: full-text
notes: "Project Syndicate now paywalls this column after the opening paragraphs; the complete text was recovered from a pre-paywall Internet Archive snapshot (20130827170355) of http://www.project-syndicate.org/commentary/sorting-and-managing-email-messages-by-esther-dyson, extracted from the page's itemprop=\"articleBody\" block via the id_ replay form."
---
...
PHOENIX – You may have heard of the [“quantified self”](http://www.project-syndicate.org/commentary/the-quantified-community) movement – the idea that you monitor your own vital signs such as weight or blood sugar, and then (ideally) adjust your behavior in order to stay healthy. Sometimes I half-joke that the primary metric that I monitor is my email inbox count: When it’s high, I’m too busy and stretched thin; when it’s low, I’m on top of things and able to concentrate on more important matters.
