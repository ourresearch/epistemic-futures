---
title: "Technology’s Mental Frontier"
person: esther-dyson
section: by
type: op-ed
year: 2012
...
source_url: https://www.project-syndicate.org/commentary/technology-s-mental-frontier-by-esther-dyson
retrieved: 2026-08-14
content: full-text
notes: "Project Syndicate now paywalls this column after the opening paragraphs; the complete text was recovered from a pre-paywall Internet Archive snapshot (20120824070350) of http://www.project-syndicate.org/commentary/technology-s-mental-frontier-by-esther-dyson, extracted from the page's itemprop=\"articleBody\" block via the id_ replay form."
---
...
But, for society as a whole, there are fewer technological constraints to guide us in what we can do – or prevent. Countries will increasingly find that their priorities must reflect broad public sentiment rather than that of a ruling elite. But all kinds of people may be tempted to make harmful tradeoffs, whether for short-term pleasure or for “sex appeal” over true value.

For example, what are the tradeoffs between clean energy sources and economic development – a big issue in India and many other countries? Rich people may want to keep cars expensive and unshared, playing into the hands of others who may be scared of automated vehicles.
...
The primary solution is better education, so that a broader swath of the population is informed enough to make fact-based judgments in both their personal and public lives. Just as we are beginning to understand how to model the climate (not without some political interference), so will we begin to understand how to model the economy – and with it, the tradeoffs that we face. It is not that everything can be reduced to a price – two months of Grandpa Juan’s life versus four years of schooling for little Alice – but that even decisions based on nonmonetary values have real costs and consequences. Most important of all, as we become better at modeling, we will discover how much value we can create (and how many costs we can avoid) by spending now to create a better future.
...
Reprinting material from this Web site without written consent from *Project Syndicate* is a violation of international copyright law. To secure permission, please [contact us](mailto:distribution@project-syndicate.org?subject=Secure permission: Technology’s Mental Frontier by Esther Dyson).
...
[Get another CAPTCHA](javascript:Recaptcha.reload())
[Get an audio CAPTCHA](javascript:Recaptcha.switch_type('audio'))
[Get an image CAPTCHA](javascript:Recaptcha.switch_type('image'))
[Help](javascript:Recaptcha.showhelp())
