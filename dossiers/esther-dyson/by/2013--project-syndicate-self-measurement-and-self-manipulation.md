---
title: "Self-Measurement and Self-Manipulation"
person: esther-dyson
section: by
type: op-ed
year: 2013
...
source_url: https://www.project-syndicate.org/commentary/learning-our-own-healthy-habits-by-esther-dyson
retrieved: 2026-08-14
content: full-text
notes: "Project Syndicate now paywalls this column after the opening paragraphs; the complete text was recovered from a pre-paywall Internet Archive snapshot (20130926184245) of http://www.project-syndicate.org:80/commentary/learning-our-own-healthy-habits-by-esther-dyson, extracted from the page's itemprop=\"articleBody\" block via the id_ replay form."
---
...
I think about this challenge a lot these days, because my new startup, called HICCup ([Health Initiative Coordinating Council](http://www.hiccup.co/)), aims (in part) to help people do just that on a massive scale, though initially concentrated in just a few communities. The point is not to turn everyone into an obsessive calorie-, weight-, or step-counter, but to get people to be better self-manipulators.
...
Calories do count; the physics of energy works even in the human body. But the kind of food you eat and when you eat it does influence how hungry you feel (and thus your self-control), and whether you use up the calories you eat or turn them into fat even as you still feel hungry. (Sugar is the main culprit, as Robert Lustig, the author of *[Fat Chance](http://www.us.penguingroup.com/nf/Book/BookDisplay/0,,9781594631009,00.html)*, has argued.)
...
Or read [*Predictably Irrational*](http://www.e-reading-lib.com/bookreader.php/138702/Predictably_Irrational;_The_Hidden_Forces_That_Shape_Our_Decisions.pdf), by Dan Ariely, and apply it to your own health and behavior. As Ariely points out, general advice is generally useless. Individuals need their own tricks, and each person knows best what will work for them – if they think about it.
...
For many people, the next big development will be non-invasive blood analysis, so that everyone, not just super-motivated diabetics, can test their own blood and understand their own metabolic chemistry. Just what does a doughnut do to your blood sugar? If Lustig is right and eating sugar just makes you hungry, you can see the mechanics for yourself.
