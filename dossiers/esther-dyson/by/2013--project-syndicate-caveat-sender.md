...
source_url: https://www.project-syndicate.org/commentary/putting-a-price-on-inbox-access-by-esther-dyson
retrieved: 2026-08-14
content: full-text
notes: "Project Syndicate now paywalls this column after the opening paragraphs; the complete text was recovered from a pre-paywall Internet Archive snapshot (20130828103338) of http://www.project-syndicate.org/commentary/putting-a-price-on-inbox-access-by-esther-dyson, extracted from the page's itemprop=\"articleBody\" block via the id_ replay form."
---
...
But the main question is why anyone should pay to send e-mail when they can do so for free. Isn’t it unfair to cut off access? Does it restrict freedom of speech?
