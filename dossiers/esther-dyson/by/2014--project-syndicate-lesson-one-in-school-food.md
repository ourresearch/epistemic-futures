---
title: "Lesson One in School Food"
person: esther-dyson
section: by
type: op-ed
year: 2014
...
source_url: https://www.project-syndicate.org/commentary/esther-dyson-suggests-that-the-shift-to-healthier-school-lunches-could-trigger-much-broader-social-change
retrieved: 2026-08-14
content: full-text
notes: "Project Syndicate now paywalls this column after the opening paragraphs; the complete text was recovered from a pre-paywall Internet Archive snapshot (20150306144917) of http://www.project-syndicate.org:80/commentary/esther-dyson-suggests-that-the-shift-to-healthier-school-lunches-could-trigger-much-broader-social-change, extracted from the page's itemprop=\"articleBody\" block via the id_ replay form."
---
...
But earlier this month I attended School Food FOCUS’s [“National Gathering.”](http://www.schoolfoodfocus.org/events/2014-national-gathering/) I found it both heartwarming and thought-provoking.

A little context: In the United States, subsidized school lunches [started in 1946](http://www.law.cornell.edu/uscode/text/42/1779) as a welfare program – but one focused on the welfare of farmers, not schoolchildren. The primary purpose was to help farmers get rid of – I mean, distribute generously – their surplus production.
...
Indeed, how to change school lunches has more to do with money and business than with health and nutrition. (The latter goals are clear; the challenge is how to achieve them.) School Food FOCUS, an arm of the New York-based non-profit [Public Health Solutions](http://www.healthsolutions.org/), convenes its members – food managers from 36 large US school districts, serving more than four million children daily – and brings in researchers, partner philanthropies (mostly healthy-food advocates), and food vendors. Indeed, FOCUS turns the vendors into allies – and sponsors. The National Gathering was a trade show as much as an event for bureaucrats and philanthropists.
...
Like most large-scale social change, the shift to mass consumption of healthier food requires both awareness and capacity. Just as recycling has gained currency through both regulation and a new social consciousness, vendors who learn how to sell healthy food to schools may someday tap a much larger adult market, whether because of regulation, a change in expectations, or the simple fact that their customers have grown up.
