---
title: "Wikipedia: A Multigenerational Pursuit"
person: selena-deckelmann
section: by
type: blog-post
year: 2024
date: 2024-03-05
venue: "Diff (Wikimedia Foundation)"
authors: "Selena Deckelmann"
source_url: https://diff.wikimedia.org/2024/03/05/wikipedia-a-multigenerational-pursuit/
...
## Wikipedia: A Multigenerational Pursuit
 ...
 5 March 202425 March 2024 by [Selena Deckelmann](https://diff.wikimedia.org/author/selena-deckelmann/), Chief Product & Technology Officer, Wikimedia Foundation 
...
*This article is an adapted version of a speech given at [WikiConference North America](https://en.wikipedia.org/wiki/WikiConference_North_America) in November 2023, also published [in the Signpost](https://en.wikipedia.org/wiki/Wikipedia:Wikipedia_Signpost/2024-01-10/Technology_report)*.
...
I grew up in [Montana](https://en.wikipedia.org/wiki/Montana), in the western half of the United States, but I also grew up on the road. My stepfather was part of a pipefitter-welder union, and we traveled to where the work was. We traveled so much that the places that stand out were all shared spaces.

I especially loved the shared space at the public library in downtown [Kalispell, Montana](https://en.wikipedia.org/wiki/Kalispell,_Montana). It was an incredible place. I truly looked forward to the time I spent there, which was pretty often after school until one of my parents got off work.

I was lucky enough to have a wonderful children’s librarian who spent a ton of time with me, recommending books based on what I liked, talking with me about school and explaining how libraries worked. He explained the card catalog and the [Dewey Decimal System](https://en.wikipedia.org/wiki/Dewey_Decimal_Classification). He showed me all the books in the kids section by [Roald Dahl](https://en.wikipedia.org/wiki/Roald_Dahl), and showed me an *[Oxford English Dictionary](https://en.wikipedia.org/wiki/Oxford_English_Dictionary)* that was available on a lectern as a reference. I got lots of nerd points when I went to university for aspiring to own an OED myself.
...
### One Year In[](https://en.wikipedia.org/wiki/Wikipedia:Wikipedia_Signpost/2024-01-10/Technology_report#One_Year_In)[](https://en.wikipedia.org/wiki/Wikipedia:Wikipedia_Signpost/2024-01-10/Technology_report#One_Year_In)
...
I knew many Wikipedians before I started at the Foundation, and since starting I’ve been able to revive connections and also meet many of you for the first time. I’m lucky to live in [Portland, Oregon](https://en.wikipedia.org/wiki/Portland,_Oregon), also the hometown of [Ward Cunningham](https://en.wikipedia.org/wiki/Ward_Cunningham), who coined the phrase “[wiki](https://en.wikipedia.org/wiki/Wiki),” and who is a friend and advisor to me.

I’ve also been having meetups at a very Portland kind of place: a Book Pub (they sell new and used books, and you can sit in the stacks with a pint and have dinner). I’ve met up with local Wikipedians there, and some folks from the [Cascadia Wikimedians User Group](https://meta.wikimedia.org/wiki/Cascadia_Wikimedians). I’ve been incredibly lucky to get to attend a handful of in person conferences, and meet hundreds of volunteers online, on wiki, on IRC and in video chats. Some of you have written me letters and I have appreciated meeting (sometimes frustrated) folks who are trying to make things better.

### Big Questions[](https://en.wikipedia.org/wiki/Wikipedia:Wikipedia_Signpost/2024-01-10/Technology_report#Big_Questions)[](https://en.wikipedia.org/wiki/Wikipedia:Wikipedia_Signpost/2024-01-10/Technology_report#Big_Questions)
...
In a recent conversation I had with [Audrey Tang](https://en.wikipedia.org/wiki/Audrey_Tang), Taiwan’s first Digital Minister, she compared Wikipedia to fire. Wikipedia is the one place on the internet that has taken potentially destructive debate, harnessed it, and turned it into energy that fuels truth and understanding among people.
...
There’s [increasing regulation](https://medium.com/wikimedia-policy/if-congress-repeals-section-230-what-will-that-mean-for-wikipedia-691559dfb2c5), and also [censorship threats](https://wikimediafoundation.org/news/2023/02/03/wikimedia-foundation-urges-pakistan-telecommunications-authority-to-restore-access-to-wikipedia-in-pakistan/), that affect Wikipedia.

We are also seeing a decline in a vital group of Wikipedians – our admins, whose work is crucial to how content is produced and maintained over the long term. A report from *The Signpost* in October shows that “we hit a new record low, going back over a decade, of 448 active admins. To find the last time English Wikipedia had fewer than 449 active admins, we have to go back to 2005.”[[1]](https://en.wikipedia.org/wiki/Wikipedia:Wikipedia_Signpost/2024-01-10/Technology_report#cite_note-1)

An earlier report from *The Signpost*, in August, says that “99% of our admins made their first edits over four and a half years ago. […] Over 90% of current admins made their first edit before I wrote that article [thirteen years ago].”[[2]](https://en.wikipedia.org/wiki/Wikipedia:Wikipedia_Signpost/2024-01-10/Technology_report#cite_note-2)

So, we have options. One might be to change nothing; maybe this project is a one-generation wonder.

Or, we could figure out what we all need to ensure our projects survive the sea changes coming our way. I know that there is a lot of Wikipedia history about how some pundits treat every big tech change as the [impending death of Wikipedia](https://en.wikipedia.org/wiki/Wikipedia:Imminent_death_of_Wikipedia_predicted). And over two decades later, that just has not been true. That said, I do think we have to face multiple things coming our way all at the same time – especially when our own numbers seem to be shrinking, not growing.
...
In the last couple of months, we shipped changes that enabled a better backbone for [PageTriage](https://www.mediawiki.org/wiki/Extension:PageTriage), and worked closely with volunteer developers to ensure future sustainability. Going forward, we have a number of initiatives ranging from projects like [Edit Check](https://www.mediawiki.org/wiki/Edit_check), [Discussion Tools](https://www.mediawiki.org/wiki/Extension:DiscussionTools), [Dark mode](https://diff.wikimedia.org/2023/11/24/dark-mode-is-coming/), [Patrolling on Android](https://www.mediawiki.org/wiki/Wikimedia_Apps/Team/Android), [Watchlist on iOS](https://www.mediawiki.org/wiki/Wikimedia_Apps/Team/iOS), [Automoderator](https://www.mediawiki.org/wiki/Moderator_Tools/Automoderator), [Community Configuration](https://www.mediawiki.org/wiki/Growth/Community_configuration), the [Wikimedia Commons Upload Wizard](https://commons.wikimedia.org/wiki/Commons:Upload_Wizard), and others.
...
With the input and help of volunteers and Foundation staff, I’ve been making and supporting a number of key decisions: First, we’re changing how we partner with the community. For example, the Foundation has changed how we create and launch [fundraising banners](https://en.wikipedia.org/wiki/Wikipedia:Fundraising/2023_banners#Collaboration_spaces) in response to RfCs and with ongoing feedback from volunteers.

In the product and tech space, we’re using research methods that [solicit prototypes directly from volunteers](https://www.mediawiki.org/wiki/Reading/Web/Accessibility_for_reading/Community_prototype_testing) for informing typography decision making. And we’re learning not just the basics of font size and spacing, we’re also getting important information about context, devices and cultural aspects of the use of Wikipedia which are vital for helping make our software easier to use as how people use and access it changes (and it has changed a lot over 20 years!).
...
Both Maryana and I started our time at the Foundation by taking a listening tour, where we each got the chance to meet so many of you. I deeply valued the time I spent speaking to you about your plans, your hopes for the movement, the roadblocks you met in your work. As Maryana [recently shared](https://meta.wikimedia.org/wiki/Wikimedia_Foundation_Community_Affairs_Committee/Talking:_2024#October_2023_Update_and_Invite), we’re kicking off another listening tour similar to that first one, called Talking:2024. So: [schedule a time](https://meta.wikimedia.org/wiki/Wikimedia_Foundation_Community_Affairs_Committee/Talking:_2024#Let's_talk) to speak with me. I want to hear from you about what you’re working on, and what problems we can solve together.

#### Share this:
- [Share on Mastodon (Opens in new window)
 Mastodon](https://diff.wikimedia.org/2024/03/05/wikipedia-a-multigenerational-pursuit/?share=mastodon)
- [Share on Bluesky (Opens in new window)
 Bluesky](https://diff.wikimedia.org/2024/03/05/wikipedia-a-multigenerational-pursuit/?share=bluesky)
- 
...
### Can you help us translate this article?
 ...
 [Start translation](https://diff.wikimedia.org/wp-login.php?redirect_to=%2F2024%2F03%2F05%2Fwikipedia-a-multigenerational-pursuit%2F%23translate-post)
...
#### Meta
 ...
 Posted in [Main page (EN)](https://diff.wikimedia.org/category/main-page-en/), [Movement Strategy](https://diff.wikimedia.org/category/movement-strategy/), [Technology](https://diff.wikimedia.org/category/technology/)Tagged [WikiConference](https://diff.wikimedia.org/tag/wikiconference/), [Wikipedia](https://diff.wikimedia.org/tag/wikipedia/) 
