...
source_url: https://www.chesnok.com/daily/2011/10/28/going-from-vagrant-and-puppet-into-ec2-a-short-survey-of-5-tools-and-two-i-didnt-bother-trying/
...
- Reuse my existing puppet configs as much as possible

- Have a completely automated deploy of a server system (including checkouts of code from a private github repo)

- Have a puppetmaster in EC2

- Be able to provision systems from EC2 or my laptop

- Make the whole process easy for my coworkers
...
- [Juju](http://www.slideshare.net/derleiermann/juju-puppetconf)
I just wasn’t sure this was a reasonable thing to install/use. No one I knew had ever heard of it. Didn’t try it.

- [Mcollective + tools ported to PHP](http://www.devco.net/archives/2010/07/14/bootstrapping_puppet_on_ec2_with_mcollective.php)
...
- [Custom scripts based on the ec2-tools packages](http://www.codelord.net/2010/12/19/using-puppet-to-automatically-configure-new-ec2-instances/)
This approach works, but is fragile and a PITA to keep updated. I tried it as a “getting oriented” exercise, and abandoned it.

- [Mccloud](https://github.com/jedi4ever/mccloud)
...
- [PuppetLab’s Cloud Provisioner](https://github.com/puppetlabs/puppetlabs-cloud-provisioner)
