...
source_url: https://www.chesnok.com/daily/2014/05/02/release-engineering-a-draft-of-an-architecture-diagram/
...
Behold: [](http://www.chesnok.com/daily/wp-content/uploads/2014/05/releng-flow-onepage.png)

And here’s a version that includes some “tree closure reasons” in magenta:

[](http://www.chesnok.com/daily/wp-content/uploads/2014/05/releng-flow-onepage-treeclosure-reasons.png)

A tree closure is defined as an hg hook that prevents people from committing to a tree (like mozilla-central). It looks up status at [treestatus.mozilla.org](http://treestatus.mozilla.org) to figure out whether or not the tree is closed, and this value is updated manually by “sheriffs” who track tree status.

And the an initial key to the tree closure reasons (the numbers on the magenta blobs), is documented on the [Mozilla wiki](https://wiki.mozilla.org/ReleaseEngineering/OverviewArchitectureDiagram).
