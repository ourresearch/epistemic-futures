...
date: 2015-01-08
venue: "cluetrain.com"
authors: "Doc Searls, David Weinberger"
source_url: http://cluetrain.com/newclues/
retrieved: 2026-08-13
content: full-text
notes: "Sixteen-years-later sequel to The Cluetrain Manifesto, 121 numbered clues. Published CC0 (all copyright waived) by the authors. Clue numbers/anchor links stripped in extraction; prose retained in order. Wired republished the same text the same day as 'Internet Under Fire Gets New Manifesto' (https://www.wired.com/story/internet-under-fire-gets-new-manifesto/, 2015-01-08); 9-gram overlap with this file is 0.92, so that republication is deliberately not saved as a separate item."
---
...
In that time the People of the Internet — you and me
and all our friends of friends of friends, unto the last Kevin Bacon —
have made the Internet an awesome place, filled with wonders and
portents.

From the serious
to the lolworthy to the wtf,
we have up-ended titans, created heroes, and changed the most
basic assumptions about

How Things Work and Who We Are.

But now all the good work we've done together faces
mortal dangers.

When we first came before you, it was to warn
of the threat posed by those who did not understand that they did not
...
well. They view it as theirs to plunder, extracting our data and money
from it, thinking that we are the fools.

But most dangerous of all is the third
horde: Us.

A horde is an undifferentiated mass of people.
But the glory of the Internet is that it lets us connect as diverse
and distinct individuals.

We all like mass entertainment. Heck, TV's
gotten pretty great these days, and the Net lets us watch it when we
want. Terrific.

But we need to remember that delivering mass
media is the least of the Net's powers.

The Net's super-power is connection
without permission. Its almighty power is that we can make of it
whatever we want.
...
beginning. We have grown old together on the Internet. Time is short.

We, the People of the Internet, need to
remember the glory of its revelation so that we reclaim it now in the
name of what it truly is.
...
Women in Saudi Arabia can't drive? Meanwhile, half
...
As
we move from the Web to an app-based
world, we lose the commons we were building together.
...
Non-neutral
applications built on top of the neutral Net are becoming
as inescapable as the pull of a black hole.
...
These New Clues are designed to be shared and
re-used without our permission. Use them however you want. Make them
your own. We only request that you please point back at this
original page ( http://cluetrain.com/newclues/ ) because that's just polite.
...
The photograph at the top of the armadillo and the
bike was posted at Flickr
by e. res
under a Creative
Commons BY 2.0 license that lets anyone use it so long as
they attribute it to her/him and share it with others. (We edited it
to make it work better with this page. Nice snap, though, e. res!)
...
Join us at [email protected]. Or Facebook. Sigh.

To the extent possible under law,

David Weinberger and Doc Searls
