...
venue: "anildash.com"
authors: "Anil Dash"
source_url: https://anildash.com/2020/05/07/when-everything-crashes/
retrieved: 2026-08-13
content: full-text
notes: "tags: culture, software, tech, web, iphone"
---
...
For apps, or more specifically for the companies that _create_ popular apps, using Facebook login is appealing — users already have an account. Easy! And Facebook made it even easier to take advantage of their billions of logged-in users by writing the code _for_ you if you’re a programmer who wants that feature. You can just go get it for free, and plug it into your app pretty quickly and simply. The tricky part, though is that now your app is dependent on that code from Facebook. You have to trust that it works the way they say it will, or you have to read all the code and fully understand it. (That’s almost as much work as just writing the code yourself.)
...
These issues matter a lot. Our kids are now spending all day connected to apps that use this code. We’ll need to have trusted apps for COVID tracing that _don’t_ have these issues — but even if they are done right, many won’t trust them because they’ve learned to be skeptical.
