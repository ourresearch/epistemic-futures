---
title: "The Year I Didn’t Retweet Men"
person: anil-dash
section: by
type: essay
year: 2014
date: 2014-02-12
venue: "Medium (the-web-we-make)"
authors: "Anil Dash"
source_url: https://medium.com/the-web-we-make/the-year-i-didnt-retweet-men-79403a7eade1
retrieved: 2026-08-13
content: full-text
notes: "Medium blocks non-browser clients; recovered from the Wayback Machine snapshot 20180308062620 (https://web.archive.org/web/20180308062620id_/https://medium.com/the-web-we-make/the-year-i-didnt-retweet-men-79403a7eade1). Medium UI chrome stripped."
---
...
CEO of Fog Creek Software, makers of @Glitch & Manuscript. Trying to make tech more ethical & humane. (Also an advisor to Medium.) More: http://anildash.com/
...
http://www.flickr.com/photos/leehaywood/4262220105/
...
Twitter Analytics breakdown of @anildash followers by gender, February 12, 2014

More than a year ago, I began to look at a different aspect of my Twitter experience, the identities of the people whom _I_ follow. Part of the reason was that we’ve been building this tool called [ThinkUp](<https://thinkup.com/>), which is all about being more thoughtful about the way we use our social networks. But part of it was my growing sense of social responsibility about what messages I choose to share and amplify, and whose voices and identities I strive to bring to a broader audience.

At the time, there were tools (since gone offline) that would imprecisely estimate the gender of people you follow by using lists of names commonly used by various genders, and they showed that I was following roughly 52% men and 48% women, not counting accounts that belonged to organizations. These tools do not account for other genders or identities, and I have not been able to find software which does, so I only have statistics which represent gender as a binary, unfortunately. (Like my cofounder Gina Trapani, I don’t believe in [drop-down identities](<http://smarterware.org/7388/the-case-against-drop-down-identities>), so I’d welcome software that better models the actual people I’m connected to.)

* * *

In the midst of this research, I found the [Twee-Q](<http://twee-q.com/>) tool, another imprecise-but-useful bit of software which showed a guessed gender for people whose voices I was amplifying through retweets. I don’t remember the exact calculation, but at the time, I believe my RTs were about 80% men.
...
The only significant challenge to this rule that I faced in 2013 was the [@3rdeyegirl](<https://twitter.com/3rdeyegirl>) account, which was nominally staffed by Prince’s (all-woman) band 3rd Eye Girl, but which I knew was also often ghost-written by Prince. For the most part, the account posted nothing substantial enough to be worth retweeting, so I didn’t think about it until August, when [Prince made official](<http://www.stereogum.com/1437942/prince-joins-twitter/news/>) his presence on the account. So I retweeted his first tweet and then went back to observing my rule.

### So, What Happened?

Maybe the most surprising thing about this experiment in being judicious about whom I retweet is how _little_ has changed. I just pay a little bit of attention before I tap on the icon in my Twitter app, but it’s been effortless to make the switch, and has gotten me far more “thanks for the retweet!” messages than I used to get.
...
[](<https://medium.com/@anildash?source=footer_card> "Go to the profile of Anil Dash")

### [Anil Dash](<https://medium.com/@anildash> "Go to the profile of Anil Dash")

Medium member since Mar 2017

CEO of Fog Creek Software, makers of [@Glitch](<http://twitter.com/Glitch> "Twitter profile for @Glitch") & Manuscript. Trying to make tech more ethical & humane. (Also an advisor to Medium.) More: <http://anildash.com/>

* Follow

[](<https://medium.com/the-web-we-make?source=footer_card> "Go to The Web We Make")

### [The Web We Make](<https://medium.com/the-web-we-make?source=footer_card>)

Trying to document the principles which make the social web what it is.
