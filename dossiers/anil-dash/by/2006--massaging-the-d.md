...
venue: "anildash.com"
authors: "Anil Dash"
source_url: https://anildash.com/2006/07/19/massaging-the-d/
retrieved: 2026-08-13
content: full-text
notes: "tags: tech, flickr"
---
...
For those who’ve never tried it, the behavior is simple. You type in _your.site_`.ishavingamassage.com` into your browser, and it displays a custom Massage Message, coloring the text of the _your.site_ part of the address Flickr-style, converting any dots in the URL to spaces, and removing a penultimate “e” character if the last letter of the site name is an “r”. Not rocket science, but it amused me for the hour or so it took to build.
